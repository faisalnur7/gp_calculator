...
<div class="flex justify-end mb-4">
    <a href="/reports/inventory/pdf?{{ http_build_query(request()->all()) }}" class="inline-flex text-black items-center gap-2 bg-slate-800 hover:bg-slate-700 text-sm font-semibold px-4 py-2 rounded-xl transition">
