...
@section('subheading', 'Jewellery items with weight and value breakdown')
    ...
    <table class="w-full text-sm">
        ...
        <tbody class="divide-y divide-slate-100">
            ...
            <tr class="hover:bg-slate-50">
                ...
                <td class="px-4 py-3 text-center text-slate-600">{{ $item->documents_count }}</td>
                <td class="px-4 py-3 text-center text-slate-600">{{ $item->w_vori }}</td>
                <td class="px-4 py-3 text-center text-slate-600">{{ $item->w_ana }}</td>
                <td class="px-4 py-3 text-center text-slate-600">{{ $item->w_roti }}</td>
                <td class="px-4 py-3 text-center text-slate-600">{{ $item->w_point }}</td>
                <td class="px-4 py-3 text-center text-slate-600">{{ number_format($item->documents_sum_total_grams ?? 0, 4) }}g</td>
                <td class="px-4 py-3 text-right font-semibold text-amber-600">{{ number_format($item->documents_sum_subtotal ?? 0, 2) }}</td>
            </tr>
            @empty
