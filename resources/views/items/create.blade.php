    ...
    <form method="POST" action="/jewellery-items" class="space-y-5" enctype="multipart/form-data">
        ...
        <div>
            ...
            <div class="grid grid-cols-4 lg:grid-cols-8 gap-3">
                ...
                <div class="bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 flex flex-col justify-center">
                ...
                <div class="col-span-2 bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 flex flex-col justify-center">
