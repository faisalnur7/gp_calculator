...
<body class="bg-slate-100 min-h-screen flex">
    ...
    <aside id="sidebar" class="fixed inset-y-0 left-0 z-40 w-64 bg-slate-900 flex flex-col transition-transform -translate-x-full lg:translate-x-0">
        ...
        <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-1">
            ...
            <a href="/documents" @class(['flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition', 'bg-amber-500 text-white' => request()->is('documents*'), 'text-slate-300 hover:bg-slate-800 hover:text-white' => !request()->is('documents*')])>
            ...
            <a href="/reports/documents" @class(['flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition', 'bg-amber-500 text-white' => request()->is('reports/documents*'), 'text-slate-300 hover:bg-slate-800 hover:text-white' => !request()->is('reports/documents*')])>
